<template>
  <div class="bg">
    <div class="content">
      ...
      <div class="row animate__animated animate__fadeIn" style="margin-left:40px;">
          <div class="print-font">{{name}}</div>
          <img class="hand-write" style="height:30px;margin-left:10px;" src="../assets/同学.png" />
      </div>
      <div class="row animate__animated animate__fadeIn" style="justify-content:flex-start;margin-top:20px;margin-left:40px;">
          <img class="hand-write" style="height:40px;margin-right:10px;" src="../assets/本科期间累积进馆.png" />
          <div class="print-font">{{entryCount}}</div>
          <img class="hand-write" style="height:30px;margin-left:10px;" src="../assets/次，.png" />
          <img class="hand-write" style="height:30px;margin-left:10px;" src="../assets/借阅书刊.png" />
      ...
      <div v-if="checkoutSchoolRank>entrySchoolRank" class="row animate__animated animate__fadeIn" style="justify-content:flex-start;margin-top:10px;margin-left:40px;">
          <img class="hand-write" style="height:55px;margin-right:10px;" src="../assets/其中，借阅次数超过了.png" />
          <div class="print-font">{{checkoutSchoolRank}}%</div>
          <img class="hand-write" style="height:40px;margin-right:10px;" src="../assets/的全校同届同学。.png" />
      </div>
      <div v-else class="row animate__animated animate__fadeIn" style="justify-content:flex-start;margin-top:10px;margin-left:40px;">
          <img class="hand-write" style="height:45px;margin-right:10px;" src="../assets/其中，进馆次数超过了.png" />
